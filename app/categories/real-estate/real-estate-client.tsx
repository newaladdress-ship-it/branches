        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
          <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="text-center">
              ...
              <p className="mt-4 text-gray-600">Loading real estate businesses...</p>
            </div>
          </div>
        </main>
        <Footer />
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find trusted real estate agents, property dealers, and housing services across Pakistan
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search real estate businesses..."
                  value={searchTerm}
          ...
          <div className="mb-6">
            <p className="text-gray-600">
              Found <span className="font-semibold text-blue-600">{sortedBusinesses.length}</span> real estate businesses
            </p>
          </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-2">
                      <a
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1 px-3 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition-colors"
                      >
