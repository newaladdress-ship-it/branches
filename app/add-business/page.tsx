...
export const metadata: Metadata = {
  ...
  description: 'Add your business to Pakistan\'s free directory. Get instant online visibility, WhatsApp integration, and reach thousands of customers across Pakistan.',
